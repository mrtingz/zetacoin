...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // zetacoin: 1 days
static const int64 nTargetSpacing = 120; // zetacoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal zetacoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "zetacoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x95ac5ffff33096fddbffe97c07e0ffc0d73bcdb9ee5456c229fbb2c0235a58c1");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Novemer 23, 2013, Egypt Expels Turkish Ambassador";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1385224510; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1385224510;
            block.nNonce   = 15264;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x5c522becb894cf13bff397fa51a2375517a8bb7bf7e5c1c747d421a9f34b7958"));
